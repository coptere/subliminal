...
@click.option('--addic7ed-alternative', is_flag=True, help='Use alternative method without credentials.')
...
@click.pass_context
def subliminal(ctx, addic7ed, addic7ed_alternative, legendastv, opensubtitles, omdb, cache_dir, debug):
    ...
    if addic7ed_alternative:
        ctx.obj['provider_configs']['addic7ed'] = {'alternative': addic7ed_alternative}
    if legendastv:
